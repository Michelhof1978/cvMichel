...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
   ...
   $recaptchaSecretKey = "6Le6AmIpAAAAABRzgJENenHHli3Oa1lMJpH-onj-"; // Remplacez par votre clé privée
   ...
   if (!$recaptchaResultData['success']) {
       ...
       exit(); // Arrête l'exécution du script si le reCAPTCHA n'est pas valide.
   }
