...
<script language="javascript">
    <!-- Début
    function popup() {
      Pub=window.open("images/couverture.png","pub","toolbar=no,location=yes,directories=no,menubar=no,scrollbars=yes,status=yes,resizable=1,width=450, height=100");
    }
    // Fin -->
    </script>
