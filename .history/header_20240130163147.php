...
<body>
  ...
  <p class="display-6 text-center mt-4 mb-4 fw-bold">Développeur Web Full Stack <br>
  <p class="display-6 text-primay text-center fw-bold">React/JS &nbsp; &nbsp; Symfony/PHP</p></p>
