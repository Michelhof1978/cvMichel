...
<div class="corps size20 text lead mt-5">
    ...
    <div class="gauche col2 colorBlueDark lead mb-2">
        ...
        <div class="lead">
        -Je m’occupais de l’organisation, des animations et la gestion du personnel ainsi que de la relation client.<br>
        </div>
    ...
    <div class="gauche col1 colorBlueLight lead">
        <h2 class="activity "><strong>Shine</strong> &nbsp; <span style="color: black;">Lyon 69</span> </h2>
