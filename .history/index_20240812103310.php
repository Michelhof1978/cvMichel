...
<div class="text-center mt-5">
    <p class="fw-bold lead mb-5">Projet Client Réalisé de A à Z</p>
    ...
    <a href="https://lescaravanesdelabesbre.fr/" target="_blank">
        <img src="images/logoharmony.png" alt="Réalisation" class="logoPal img-fluid" style="width: 15%; margin-top: 50px; margin-bottom: -70px;">
    </a>  
</div>
