...
<body>
  ...
  <nav class="bg-colorBlue3">
    <ul>
      ...
      <li class="menuInfo">
        <a href="images/dp.pdf" download="dp.pdf">Téléchargement DP</a>
      </li>
  ...
  <p class="display-6 colorBlueLight text-center mt-4 mb-4 fw-bold">CV Développeur Web Full Stack</p>
<p class="size40 text-center fw-bold mb-5">Hoffmann Michel</p>

<div class="text-center mt-5">
    <a href="https://lescaravanesdelabesbre.fr/" target="_blank">
        <img src="images/logoLesCaravanesDeLaBesbre.png" alt="Réalisation Client" class="logoPal img-fluid" style="width: 50%; margin-top: 20px;">
    </a>
    <p class="fw-bold mt-3">Derniers Projets Clients Réalisés à 100%</p>
</div>
