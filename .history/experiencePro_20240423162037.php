...
<div class="corps size20 text lead">
    ...
    <div class="gauche col1 colorBlueLight lead">
        <h2 class="borderBottomDark "><strong>Harmony Digital</strong> &nbsp; <span style="color: black;">Dompierre 03</span> Moulins 03 </h2>
    ...
    <div class="gauche col1 colorBlueLight lead">
    <h2 class="borderBottomDark">
        <strong>Stellantis</strong> &nbsp; <span style="color: black;">Dompierre 03</span>
    </h2>
    ...
    <div class="gauche col1 colorBlueLight lead">
        <h2 class="borderBottomDark "><strong>Bigbang</strong> &nbsp; <span style="color: black;">Dompierre 03</span> Moulins 03</h2>
    ...
    <div class="gauche col1 colorBlueLight lead">
        <h2 class="borderBottomDark"><strong>Rouge Tendance</strong> &nbsp; <span style="color: black;">Dompierre 03</span>Lyon 69</h2>
    ...
    <div class="gauche col1 colorBlueLight lead">
        <h2 class="borderBottomDark "><strong>Shine</strong> &nbsp; <span style="color: black;">Dompierre 03</span>Lyon 69 </h2>
    ...
    <div class="gauche col2 colorBlueDark lead">
        ...
        <div class="lead mb-2">
            -Je m’occupais d’une équipe avec un planning de 12 personnes <br>
    ...
    <div class="gauche col1 colorBlueLight lead">
        <h2 class="borderBottomDark "><strong>Pino</strong>&nbsp; <span style="color: black;">Dompierre 03</span>Lyon 69</h2>
