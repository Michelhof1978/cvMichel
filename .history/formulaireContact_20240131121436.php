...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (!$resp->isSuccess()) {
        echo '<p class="alert alert-danger ms-5 mt-3 fw-bold">Erreur reCAPTCHA. Veuillez réessayer.</p>';
        // Vous pouvez également rediriger l'utilisateur ou prendre d'autres mesures appropriées en cas d'échec de la vérification.
    } else {
