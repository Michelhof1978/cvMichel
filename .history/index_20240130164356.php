...
<div class="text-center mt-5">
    ...
    <p class="fw-bold">Dernier Projet Client Réalisé de A à Z</p>
</div>
  ...
  <div class="text lead bg-light rounded shadow p-4 pb-5 bg-white rounded ms-1 me-1 ">
    ...
    <p class="lead">
      &nbsp; &nbsp; &nbsp; &nbsp; Passionné par le développement web, je suis constamment en ébullition d'idées que je m'efforce de concrétiser. <br>
       Mon intérêt marqué pour l'aspect créatif de ce domaine m'a motivé à entreprendre une reconversion professionnelle et à reprendre mes études. <br>
       Autodidacte de nature et toujours avide d'apprendre, je tire profit de mes expériences pour répondre au mieux aux exigences des clients.<br> Flexible quant aux déplacements, je suis prêt à relever de nouveaux défis, que ce soit en équipe ou en autonomie. <br>
       Mon sens du contact naturel complète mes compétences techniques, faisant de moi un professionnel adaptable et déterminé.<br>
       <p class="fw-5 text-center lead">Je suis reconnu RQTH permanent qui ne nécessite aucun aménagement de poste.</strong>
      </p>
    ...
    <div>
      ...
      BAC : Restauration <br>
      <div class="activity">Sévigné - Gap 09/1998 – 07/1999<br>
        <hr>
      </div>

      CAP / BEP : Restauration <br>
      <div class="activity">Sévigné - Gap 09/1996 – 07/1998<br>
        <hr>
      </div>
