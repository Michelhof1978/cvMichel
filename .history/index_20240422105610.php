...
<div class="text-center mt-5">
  ...
  <div class="text lead bg-light rounded shadow p-4 pb-5 bg-white rounded ms-1 me-1 ">
    ...
    <div class="domaineCompetence lead">
      <table>
        <tr>
          <th class="colorBlueLight lead"><strong></strong>Compétences</th>
          <th class="colorBlueLight lead"><strong></strong>Détail</th>
          <th class="colorBlueLight lead"><strong></strong>Niveau</th>
        </tr>
    ...
    <h2 class="colorBlueDark size40 borderBottomDark"><strong></strong>Formation</h2>
    ...
    <h2 class="colorBlueDark size40 borderBottomDark"><strong></strong>Activités personnelles</h2>
