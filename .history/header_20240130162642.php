...
<body>
  ...
  <p class="display-6 colorGold text-center mt-4 mb-4 fw-bold">Développeur Web Full Stack <br><p class="colorGold text-center fw-bold">React/JS &nbsp; &nbsp; Symfony/PHP</p></p>
