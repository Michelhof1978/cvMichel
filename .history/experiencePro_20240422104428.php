...
<div class="corps size20 text lead">
    ...
    <div class="gauche col1 colorBlueLight lead">
        <h2 class="borderBottomDark "><strong></strong> Harmony Digital</h2>
    ...
    <div class="gauche col1 colorBlueLight lead">
        <h2 class="borderBottomDark "><strong></strong>Psa</h2>
        <div class="lead">07/2006 - 06/2022 </div>
    </div>

    <div class="gauche col2 colorBlueDark lead">
        <h2 class="borderBottomDark"><strong></strong>Conducteur d'installation</h2>
        <div class="lead">
    ...
    <div class="gauche col1 colorBlueLight lead">
        <h2 class="borderBottomDark "><strong></strong>Bigbang</h2>
        <div class="lead">04/2008 - 12/2016 </div>
    </div>

    <div class="gauche col2 colorBlueDark lead">
        <h2 class="borderBottomDark "><strong></strong>Dj, Animateur et gérant de société</h2>
        <div class="lead">
    ...
    <div class="gauche col1 colorBlueLight lead">
        <h2 class="borderBottomDark"><strong></strong>Tendance</h2>
        <div class="lead">03/2003 - 07/2006 </div>
    </div>

    <div class="gauche col2 colorBlueDark lead">
        <h2 class="borderBottomDark "><strong></strong>Responsable de salle</h2>
        <div class="lead">
    ...
    <div class="gauche col1 colorBlueLight lead">
        <h2 class="borderBottomDark "><strong></strong>Shine</h2>
        <div class="lead">04/2002 - 08/2004 </div>
    </div>

    <div class="gauche col2 colorBlueDark lead">
        <h2 class="borderBottomDark "><strong></strong>Responsable événementiel</h2>
        <div class="lead">
    ...
    <div class="gauche col1 colorBlueLight lead">
        <h2 class="borderBottomDark "><strong></strong>Pino</h2>
        <div class="lead">09/1999 - 04/2002 </div>
    </div>

    <div class="gauche col2 colorBlueDark lead">
        <h2 class="borderBottomDark"><strong></strong>Chef de rang et maître d'hôtel </h2>
        <div class="lead">
