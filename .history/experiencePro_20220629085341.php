...
<head>
  <meta charset="utf-8">
  <meta name="description" content="Page listant les expériences pro de Michel HOFFMANN">
  <title>Expériences Pro</title>
...
<div class="corps size20">
    <div class="gauche col1 colorBlueLight">
       ...
       <div>07/2006 - 06/2022 </div>
</div>

<div class="gauche col2 colorBlueDark">
    <h2 class="borderBottomDark">Responsable d'unité</h2>
    <div>
    ...
    <div class="gauche col1 colorBlueLight">
        <h2 class="borderBottomDark ">Bigbang</h2>
       <div>04/2008 - 12/2016 </div>
</div>

<div class="gauche col2 colorBlueDark">
    <h2 class="borderBottomDark ">DJ et animateur</h2>
    <div>
        -Organisation et animation d'évévenements.<br>
        -relations clients
        </div><br/>
</div>

<div class="gauche col1 colorBlueLight">
    <h2 class="borderBottomDark">Tendance</h2>
   <div>03/2003 - 07/2006  </div>
</div>
<div class="gauche col2 colorBlueDark">
...
<div>
    ...
    -A épaulé le directeur d'exploitation dans le cadre des décisions opérationnelles quotidiennes.
