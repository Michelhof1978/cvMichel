  ...
  <div class="text lead bg-light rounded shadow p-4 pb-5 bg-white rounded ms-1 me-1 ">
    ...
    <p class="">
      &nbsp; &nbsp; &nbsp; &nbsp; Passionné par le développement web, je suis constamment en ébullition d'idées que je m'efforce de concrétiser. <br>
       ...
       Autodidacte de nature et toujours avide d'apprendre, je tire profit de mes expériences pour répondre avec excellence aux exigences des clients. Flexible quant aux déplacements, je suis prêt à relever de nouveaux défis, que ce soit en équipe ou en autonomie. Mon sens du contact naturel complète mes compétences techniques, faisant de moi un professionnel adaptable et déterminé.
    </p>
