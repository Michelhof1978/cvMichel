...
<div class="text-center mt-5">
  ...
  <div class="text lead bg-light rounded shadow p-4 pb-5 bg-white rounded ms-1 me-1 ">
    ...
    <p class="lead">
      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Développeur web passionné et autodidacte, je suis animé par une passioncréative qui a guidé ma reconversion professionnelle et la poursuite de mes étudesdans ce domaine. <br>
      ...
      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Disponible et mobile, je suis prêt à relever de nouveaux défis, que ce soit encollaboration au sein d'une équipe ou de manière indépendante.EMPLOISÉDUCATION1996 - 1999Diplôme de niveau bac +2 Développeur Web<br>
      </p>
