...
<body>
  ...
  <<div class="text-center mt-4">
    <a href="https://lescaravanesdelabesbre.fr/" target="_blank">
        <img src="images/logoLesCaravanesDeLaBesbre.png" alt="Réalisation Client" class="logoPal img-fluid" style="max-width: 50%;">
    </a>
    <p class="fw-bold mt-2">Projets Clients Récemment Menés à Bien à 100%</p>
</div>
