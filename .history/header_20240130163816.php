...
<body>
  ...
  <p class="fs-7 lead text-center mt-4 mb-4 fw-bold">Développeur Web Full Stack <br>
  <p class=" fs-5 lead text-primary text-center fw-bold">React/JS &nbsp; &nbsp; Symfony/PHP</p></p>
<p class="size40 lead text-center fw-bold mb-5">Hoffmann Michel</p>
