...
<body>
  ...
  <div class=" text-center mt-5">
        <p class="size40   text-center fw-bold">Derniers Projet Client Réalisé à 100 ù</p>
        <a href="https://lescaravanesdelabesbre.fr/" target="_blank"><img src="../images/logoLesCaravanesDeLaBesbre.png" alt="logo office du tourisme"  class="logoPal img-fluid w-25"></a>
    </div>